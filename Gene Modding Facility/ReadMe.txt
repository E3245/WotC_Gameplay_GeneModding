...
[olist]
	[*]You assign whomever you want to the facility slot. They must be healthy/active.
	[*]You then get a screen with all of the available Gene Mods. Select one and hit the green button or, if on controller, the A button.
	[*]You'll get a prompt. Select Accept or back.
	[*]The magic will then happen. Soldiers are unavailable during the duration, and canceling the project will waste resources and give the soldier a negative trait that can be removed either by completing a Gene Mod project or using the Infirmary to remove the trait.
[/olist]
...
If you have issues with this mod or spotted a bug, please report it in the [url=https://steamcommunity.com/workshop/filedetails/discussion/1877861493/1631916887483588164/]Bug Report Thread[/url]. If you want to provide feedback, whether its good or bad, then post in the [url=https://steamcommunity.com/workshop/filedetails/discussion/1877861493/1631916887483590560/]General Feedback Thread[/url].
...
[b]Q: Does this work with a current save?[/b]
